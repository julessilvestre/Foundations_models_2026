...
class Attention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask: Optional[torch.Tensor] = None) -> torch.Tensor:
        ...
        # Reshaping to: [B, num_heads, L, head_dim]
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, context: torch.Tensor, mask: Optional[torch.Tensor] = None) -> torch.Tensor:
        ...
        raise NotImplementedError("CrossAttention forward not implemented yet.")
...
class Block(nn.Module):
    ...
    def __init__(self, dim: int, head_dim: int = 64, mlp_ratio: float = 4., use_bias: bool = False):
        ...
        self.attn = Attention(dim=dim, head_dim=head_dim, bias=use_bias)
...
class DecoderBlock(nn.Module):
    ...
    def forward(self, 
        ...
        raise NotImplementedError("DecoderBlock forward not implemented yet.")
